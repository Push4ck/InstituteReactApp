        ...
        >
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, fatherMobileNumber: e.target.value })
              }
              pattern="[0-9]{10}"
              className="rounded-md w-full h-12 px-2 border-2 focus:border-2 focus:border-sky-500"
              placeholder="mobile number"
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, motherMobileNumber: e.target.value })
              }
              pattern="[0-9]{10}"
              className="rounded-md w-full h-12 px-2 border-2 focus:border-2 focus:border-sky-500"
              placeholder="mobile number"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, migrated: e.target.checked })
                  }
                  className="h-4 w-4"
                />
                <label
              ...
              <div className="flex items-center">
                <input
                  ...
                  checked={!formData.migrated}
                  onChange={() =>
                    setFormData({ ...formData, migrated: !formData.migrated })
                  }
                  className="h-4 w-4"
                />
                <label
